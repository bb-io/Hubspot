...
public static class HtmlExtensions
{
    ...
    public static string AsHtml(this (string title, string metaDescription, string body, string pageId, string contentType) tuple)
    {
        return
            $"<html><head><title>{tuple.title}</title><meta name=\"{BlackbirdReferenceIdAttribute}\" content=\"{tuple.pageId}\"><meta name=\"{BlackbirdContentTypeAttribute}\" content=\"{tuple.contentType}\"><description>{tuple.metaDescription}</description></head><body>{tuple.body}</body></html>";
    }
